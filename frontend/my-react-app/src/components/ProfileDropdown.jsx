...
function ProfileDropdown() {
  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-48 rounded-xl border border-white/10 bg-slate-900 shadow-lg z-50 overflow-hidden">
          ...
          <button
            ...
            className="w-full text-left px-4 py-2 text-sm text-rose-300 hover:bg-rose-500/10 transition flex items-center gap-2"
          >
            🚪 Logout
          </button>
        </div>
